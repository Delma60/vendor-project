...
function OnboardingWizard() {
	...
	const requiredDocumentLabels = ['Government-issued ID', 'Business registration certificate'];
	async function handleSubmit() {
		...
		const missingDocuments = requiredDocumentLabels.filter(label => !documentFiles[label]);
